...
const openNetlifyModal = () => {
  ...
  if (netlifyIdentity) {
    ...
    netlifyIdentity.on("login", (user) => {
      axios
        .post("https://learn-algorithms.herokuapp.com/users/add", {
...
export default function Hero() {
  ...
  const backToAlgorithmsBtn = (
    <Button
      component={Link}
      to="/logged-in/insertion_sort"
      id="back-to-algoritms-btn"
      sx={{
        backgroundColor: "#ffb092",
        marginTop: "2em",
        color: "#0C1D40",
    ...
    >
      ...
      >
        ...
        <Typography
          ...
          letterSpacing=".05em"
        >
          Visual demonstrations of algorithms that help you understand them and
          implement your own.
        </Typography>
